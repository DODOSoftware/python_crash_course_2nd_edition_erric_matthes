...
#Paul 10.05.2022 - must .append() before .insert(len()), it seems that it override it at the end.
home_gym_eq.insert(len(home_gym_eq), '4 camera set with live tv screen - important!')
