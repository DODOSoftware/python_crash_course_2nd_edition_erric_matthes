...
games_list.remove( 'Duke Nukem' ) # Paul 11.05.2022 - not really that fav, I couldn't .pop() that one out, dunno why.
...
for game in games_list:
	print ( f'One of games I used to play a lot: { game.title() }!' ) # Paul 11.05.2022 - again .title(the title say FUCK ROMAN LETTERS), I'll figure it out later I guessss.
...
print ( 'I used to play a lot, thank you - especially older games - for many memories.' ) # Paul 11.05.2022 - cutting for next task after the loop, e.g. giving Play Now button displayed or some sort of summarize



''' Intendet indeted errors:

guests = [ 'albert einstein', 'elon musk', 'marek jurek', 'socrates', 'adam zborowski' ] # Paul 11.05.2022 - IndentationError: expected an indented block after 'for' statement on line __
for guest in guests:
print ( guest )
