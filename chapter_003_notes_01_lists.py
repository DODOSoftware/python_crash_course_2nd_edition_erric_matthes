...
print(f"\n\n\n\n\n\n\n{bicycles[-1].title()}")
''' index -1 is very useful, because you often want to access last item from
...
# Paul 03.05.2022 [-1] will print the last position on the list,
# [-2] second from the end, and so forth...

bicycles[3] = "rower gorski"  # Paul 03.05.2022 - I found it myself >:D

print(f"\n{ bicycles[-2].upper() } list number [-2] works when earlier I "
      f"modified list from 'mountain bike' to 'rower gorski!")

msg_1 = f"\n\tI want to have { bicycles[0].upper() } bicycle."
# Paul 03.05.2022 - f"bla bla bla {BLEBLE-method}, bla bla bla."
...
bicycles2 = ['trekking', 'cannondale', 'redline', 'mountain bike',
             'specialized']

bicycles2[1] = "wtf is this second bike?"

message2 = f"\n{ bicycles2[0] }, { bicycles2[1] }, { bicycles2[2] }, " \
           f"{ bicycles2[3] }, { bicycles2[4] }"
