...
guest_list.insert( len(guest_list), "max planck" ) # Paul 09.05.2022 - 'len(list_name)' command allows you to .insert() in the last position on the list.
...
print ( f"\n\tOne of the first games I played on 486 computer is { first_one }." ) # Paul 09.05.2022 'Doom' value is still open for use
